...
namespace Kheprx.BaseBackend.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260923142259_AddDistanceReference")]
    partial class AddDistanceReference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kheprx.BaseBackend.Identity.Domain.Entities.CompetitionStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("competition_status", "reference");
                });

            modelBuilder.Entity("Kheprx.BaseBackend.Identity.Domain.Entities.Distance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
